...
// 1. Remove useSensors hook import, bring in the type instead
...
export const Sensors: React.FC<SensorsProps> = ({ data }) => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col mx-auto w-full items-center justify-start p-4 sm:p-6 lg:p-10"
      style={{
        background: "#060b14",
        backgroundImage:
    ...
    >
      ...
      {/* Header */}
      <div className="w-full max-w-2xl mb-8 mt-4 sm:mt-0">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 sm:gap-0">
          <div>
            <div className="text-[10px] sm:text-xs tracking-[0.3em] text-slate-500 uppercase mb-1">Environmental Monitor</div>
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              SENSOR<span style={{ color: "#38bdf8" }}>_</span>DASHBOARD
            </h1>
          </div>
          <div className="text-left sm:text-right">
            <div className="text-[10px] sm:text-xs text-slate-500 tracking-widest">SYS_TIME</div>
            <div className="text-sm sm:text-base font-bold text-slate-300 tabular-nums">
